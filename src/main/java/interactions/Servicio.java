...
public class Servicio {
     ...
     * @param header   Map con las cabeceras del recurso a consumir
     */
    public static Interaction restPostNew(String resource, String body, Map header,String pathFile) {
        return instrumented(PostWithBodyParameters.class, resource, body, header,pathFile);
    }
